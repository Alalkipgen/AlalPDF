...
android { namespace = "com.alalkipgen.alalpdf"; compileSdk = 35
    defaultConfig { applicationId = "com.alalkipgen.alalpdf"; minSdk = 26; targetSdk = 35; versionCode = 3; versionName = "0.1.3-beta"; testInstrumentationRunner = "androidx.test.runner.AndroidJUnitRunner" }
    compileOptions {
